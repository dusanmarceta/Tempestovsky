...
if __name__ == "__main__":
    ...
    sim = compute_tumbling_dynamics(dt = 1000, timesteps = 100, y0 = y0,
                                        I = np.array([I1, I2, I3]), 
    ...
    #     L_hat=L_hat,
    #     omega_vectors=omega_vecs,   # Prosleđuješ results['G_axes']
    #     output_file=output_file,     # <--- OVDJE prosleđuješ ime fajla (npr. 'animacija.gif')
    #     fps=fps,
    #     skip_frames=1,
    #     hodograf_axis='x'        # Ili 'z', 'all', zavisi šta želiš da iscrtaš
    # )
    ...
    animate_rotation_inertial(shape_file = shape_file, 
                              ...
                              lambda_L_deg = 250, beta_L_deg = - 75,
    ...
    # rotations = sim['rotations']
    # L_hat = sim['L_axis']
    # omega_vecs = sim['omega_axes']
    # r_sun = sim['r_sun']
    
    # # r_1 = sim['r_body_fixed']
    # # t_1 = sim['t_body_fixed']
